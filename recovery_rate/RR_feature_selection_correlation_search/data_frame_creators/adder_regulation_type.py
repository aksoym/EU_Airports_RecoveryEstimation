...
# rr_dataframe = pd.read_pickle(
#     '/RR_feature_selection_correlation_search/rr_feature_df_pickles/rr_dataframe_munich/rr_feature_df_date_tw.pickle')


def add_regulation_features(rr_dataframe):
    regulation_list = []
