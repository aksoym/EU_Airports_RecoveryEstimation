...
class LSTMEstimator(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler2 = ReduceLROnPlateau(optimizer, mode='min', factor=0.9, patience=50, cooldown=10, min_lr=1e-10)
        return {"optimizer": optimizer, "lr_scheduler": scheduler2, "monitor": "training_loss"}
