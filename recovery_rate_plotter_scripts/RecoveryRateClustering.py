...
root_file = 'recoveryRate_pickles/'
file_name = 'Munich_allTime_recoveryRates.pickle'
pickle_path = root_file + file_name
apt_name = file_name.split('_')[0]
...
print(recovery_rate_dict['Unmasked'].values())
